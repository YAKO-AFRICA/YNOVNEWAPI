...
class StorePermissionGroupRequest extends FormRequest
{
    ...
    {
        return $this->user()?->hasPermission('permission_groups.creer') ?? false;
    }

    public function rules(): array
    {
        return [
            'libelle' => ['required', 'string', 'max:100', 'unique:permission_groups,libelle'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'parent_uuid' => 'Groupe parent',
            'route_prefix' => 'Préfixe de route',
        ];
    }
