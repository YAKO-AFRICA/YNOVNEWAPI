...
//     {
//         return UserSecurityAnswer::where('user_uuid', $user->uuid_user)
//             ->with('question')
//             ->get()
//             ->map(function ($answer) {
//                 return [
...
//         // Vérifier la réponse
//         $isValid = $userAnswer->verifyAnswer($answer);
...
//             'min_answers' => $data['min_answers'] ?? self::MIN_REQUIRED_ANSWERS,
//             'max_answers' => $data['max_answers'] ?? self::MAX_ALLOWED_ANSWERS,
//             'created_by' => $creatorUuid,
//         ]);
//     }
...
//     {
//         // Recuperer l'utilisateur qui a modifié la question de sécurité
...
//     {
//         // Recuperer l'utilisateur qui a supprimé la question de sécurité
